...
'''
def get_top_n(n : int, session : Session) -> List[TrackSchemaBase]:
...
get all the tracks
'''
def get_all(session : Session) -> List[TrackSchemaBase]:
...
'''
def get_match(word : str, session : Session) -> List[TrackSchemaBase]:
